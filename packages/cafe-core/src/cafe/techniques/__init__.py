"""Mode B — composed pipelines: register techniques, wire them with an instrumented
context, and let CAFE swap them as factors and attribute per-stage."""

from cafe.techniques.composed import composed, stage_report, technique_factor
